              ...
              slivers: [
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const JoinWhatsappPage(),
                          ),
                        );
                      },
                    ),
                ...
                SliverToBoxAdapter(
                  child: Padding(
                    ...
                    child: Text(
                      'Senenin en büyük teknoloji ve girişimicilik zirvesi olan StartTech etkinliği için tıkla!',
                      style: GoogleFonts.poppins(
                        fontSize: MediaQuery.of(context).size.width * 0.05,
                        fontWeight: FontWeight.w400,
                        color: Colors.white.withOpacity(0.8),
                      ...
                      onPressed: () async {
                        try {
                          bool launched =
                              ...
                              await launch(
                            'https://www.instagram.com/reel/C2-Z9xdtZLF/?igsh=NWQ1MGlobHlsaGJ2',
                            forceSafariVC: false,
                          );
                    ...
                    child: ElevatedButton(
                      ...
                      child: Row(
                        children: [
                          ...
                          const Spacer(),
                          Text(
                            "Sene İçindeki Eğitimler İçin Tıkla",
                            style: GoogleFonts.poppins(
                              fontSize:
                                  MediaQuery.of(context).size.width * 0.032,
                              fontWeight: FontWeight.w600,
